...
import PlayerCardIcon from '../assets/icons/PlayerCardIcon';
import OrganiserCardIcon from '../assets/icons/OrganiserCardIcon';
...
const LandingPage: React.FC<LandingPageProps> = ({ theme, toggleTheme }) => {
  ...
  return (
    <>
      ...
      {isLoginModalOpen && <LoginModal initialRole={selectedRole} onClose={() => setIsLoginModalOpen(false)} />}
